...
class Sms extends Model
{
    ...
    {
        $headers = [
            'Authorization: Basic '.base64_encode('PaySwitch:Pay1234!'),
    ...
    {
        if ( Sms::where('user_id', $user_id)->whereDate('created_at', Carbon::today()->toDateString())->count() > 2 ){
            return [
                'code'  => '100',
                'status'    => 'failed',
                'reason'    =>  'user verification limit exceeded'
            ];
        }
